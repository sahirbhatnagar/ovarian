...
#replace ID with barcode to match gene expression files
o.pheno2$ID <- substring(o.pheno2$Barcode.SNP,first=1,last=16)
o.pheno2 <- o.pheno2[!duplicated(o.pheno2$ID),]
